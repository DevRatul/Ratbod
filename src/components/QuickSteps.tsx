...
export default function QuickSteps({ darkMode, lang = 'en', onSave }: QuickStepsProps) {
  ...
  return (
    <div className={cn(
      "w-full h-[66px] sm:h-[74px] px-3.5 sm:px-5 py-2 rounded-2xl sm:rounded-3xl border flex items-center justify-between gap-2.5 sm:gap-4 overflow-hidden relative transition-all",
